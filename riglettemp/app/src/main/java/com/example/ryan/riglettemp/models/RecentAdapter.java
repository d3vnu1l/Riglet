...
public class RecentAdapter extends ArrayAdapter<Friend> {
    List<Friend> list;
    private Context context;

    public RecentAdapter(Context context, List<Friend> items) {
        super(context, R.layout.listview_home_item, items);
        this.list = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.listview_home_item, null);
